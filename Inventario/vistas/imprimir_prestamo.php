...
<?php include $_SERVER['DOCUMENT_ROOT'] . "/Inventario/inc/btn_back.php"; ?>  
    <section class="section">
        <div class="container">
            ...
            <h1 class="title">Prestamo</h1>
            
            <p class="has-text-centered" style="font-weight: bold; margin-bottom: 20px;">
                RECIBÍ: DE LA DIRECCIÓN GENERAL DE INFORMÁTICA, EN CALIDAD DE PRÉSTAMO TEMPORAL, LOS SIGUIENTES ARTÍCULOS.
            </p>
