<?php
    ...
    if($codigo=="" || $nombre=="" || $fecha=="" || $stock=="" || $categoria==""){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
    ...
    $actualizar_producto=$actualizar_producto->prepare("UPDATE producto SET producto_codigo=:codigo,producto_nombre=:nombre,producto_fecha=:fecha,producto_stock=:stock,categoria_id=:categoria WHERE producto_id=:id");
